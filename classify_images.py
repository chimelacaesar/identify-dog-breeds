...
def classify_images(images_dir, results_dic, model):
    ...
    for filename, pet_label in results_dic.items():
        ...
        # Full path of image file is used
        test_image = images_dir + filename
        
        # image_classication is a text string - It contains mixed case(both lower
        ...
        try:
            ...
            # Fill this item with defaults
            print("File", test_image, "not found in image folder.")
            pet_label.extend(["", 0])
            continue
        
        image_classification = image_classification.lower().strip()
        pet_label.append(image_classification)
